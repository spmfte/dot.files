...
# If set to an empty array, this variable will have no effect.
 ZSH_THEME_RANDOM_CANDIDATES=( "robbyrussell" "cloud" "suvash" "apple" "agnoster" "crunch" "fletcherm" "mgutz" "minimal" "norm" "pygmalion" "re5et" "refined" "superjarin" "lambda-gitster" "pi")
# "daveeverwer" "dpoggi" "dstufft" "half-life" "obraun" ""
...
alias pyproj='cd proj/py'
alias code='codium'
alias cdc='cd && c'
alias yabind='cd ~/bin && ./yabind.sh && cd ~'
...
alias miniconf='vim ~/minizsh/.zshrc'
alias miniconf!='source ~/zshmini/.zshrc'
alias calmconf='vim ~/zshcalm/.zshrc'
alias calmconf!='source ~/zshcalm/.zshrc'
alias wifipass="wifipass.sh"
