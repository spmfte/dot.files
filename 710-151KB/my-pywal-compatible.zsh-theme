...
# Define colors using Pywal colors
r_color="%F{$color1}"  # Red
b_color="%F{$color4}"  # Blue
y_color="%F{$color3}"  # Yellow
g_color="%F{$color2}"  # Green
...
# Manually apply colors for each element
