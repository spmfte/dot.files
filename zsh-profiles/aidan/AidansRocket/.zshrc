...
# To customize prompt, run `p10k configure` or edit ~/zsh-profiles/aidan/aidansrocket/.p10k.zsh.
[[ ! -f ~/zsh-profiles/aidan/aidansrocket/.p10k.zsh ]] || source ~/zsh-profiles/aidan/aidansrocket/.p10k.zsh
