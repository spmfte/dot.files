...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox = awful.wibar({ position = "top", screen = s, bg = "#00000088" }) -- The "66" is the alpha value
...
awful.spawn("feh --bg-scale ~/wallpapers/wallpapers/win-mac/OSX-11-0-Day.jpg")
awful.spawn("picom --config ~/.config/picom/picom.conf -b")
